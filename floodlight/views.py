...
from floodlight.models import SDNController, OpenFlowSwitch, OpenFlowEntry, \
    OpenFlowPort, OpenFlowTopologyLink
from floodlight.serializers import SDNControllerSerializer, \
            ...
            if values.has_key("flows") == False:
                ...
                for flow in values["flows"]:
                    ...
                    try:
                        ...
                        print "Error, There are no switch (%s)" % switch_dpid
